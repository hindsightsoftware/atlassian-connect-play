...
# deploy the jar, sources and javadocs of a previously locally published (play publish-local) play module.
...
function deploy {
  mvn deploy:deploy-file -DpomFile=$1 -Dfile=$2 -Dclassifier=$3 -DrepositoryId=atlassian-public -Durl=https://maven.atlassian.com/public
}
